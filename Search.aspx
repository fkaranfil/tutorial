...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div id="middleside">
       &nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" DataSourceID="SqlDataSource1" AllowPaging="True" GridLines="None" PageSize="4" CssClass="gridView">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:15MY03010DBConnectionString %>" SelectCommand="SELECT [ProductImagePath], [ProductName], [ProductNo], [ProductDetails] FROM [Product] where ProductName LIKE '%' +@search + '%' OR  ProductDetails LIKE '%' +@search + '%'">
            <SelectParameters>
